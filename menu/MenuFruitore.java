            	    		...
            	    		if(scegliRegola == 1) {
            	    			...
            	    			do {
	            	    			...
	            	    			//Verifica che non esista una regola con lo stesso nome
	            	    				if(ListaRegoleSempreVere.getInstance().alreadyExist(nomeRegola)) {
            	    			...
            	    			do {
            	    				...
            	    				if(ListaCategoriaAttuatori.getInstance().getCategoriaAttuatori(ListaAttuatori.getInstance().getActuatorFromList(scegliAttuatore).getCategoriaAssociata()).getListaModalitaOperativeParametriche(verifica).getNome().equalsIgnoreCase("")) {
            	    		...
            	    		//Creazione di regole con un solo sensore 
            	    			...
            	    			do {
	            	    			...
	            	    			//Verifica che non esista una regola con lo stesso nome
	            	    				...
	            	    				if(ListaRegoleSingoloSensore.getInstance().alreadyExist(nomeRegola)) {
	            	    					System.out.println(ERRORE_ESISTE_GIA_UNA_REGOLA_CON_LO_STESSO_NOME);
	            	    					nomeRegolaNonEsiste = false;
	            	    				}
            	    		...
            	    		//Creazione regola con due sensori NUMERICI 	
	            	    		...
	            	    		if(ListaSensori.getInstance().getListSize() > 1) {
	            	    			do {
		            	    			...
		            	    			//Verifica che non esista una regola con lo stesso nome
		            	    				if(ListaRegoleDueSensori.getInstance().alreadyExist(nomeRegola)) {
		            	    					System.out.println(ERRORE_ESISTE_GIA_UNA_REGOLA_CON_LO_STESSO_NOME);
		            	    					nomeRegolaNonEsiste = false;
		            	    				}
				            		...
				            		do {
				            			ListaSensori.getInstance().printList();
				            			scegliSecondoSensore = inputDati.leggiIntero(MESS_INSERISCI_IL_NUMERO_PER_SCEGLIERE_IL_SECONDO_SENSORE, 1, ListaSensori.getInstance().getListSize());
